...
- [content-alchemist](https://github.com/think-root/content-alchemist) – An API server that allows you to generate nice descriptions for GitHub repositories using only a link to the repository
- [content-maestro](https://github.com/think-root/content-maestro) – Content management for "content-alchemist", scheduled content publication on social networks, and other features in the form of an API server
- [content-sentinel](https://github.com/think-root/content-sentinel) - Essentially, a frontend for "content-alchemist" and "content-maestro" in the form of a dashboard
